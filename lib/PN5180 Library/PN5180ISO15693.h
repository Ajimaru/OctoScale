...
public:
  ...
  ISO15693ErrorCode getSystemInfo(uint8_t *uid, uint8_t *blockSize, uint8_t *numBlocks,
                                   uint8_t *dsfidOut = nullptr, bool *dsfidPresentOut = nullptr,
                                   uint8_t *afiOut = nullptr, bool *afiPresentOut = nullptr,
                                   uint8_t *icRefOut = nullptr, bool *icRefPresentOut = nullptr);
